# These step definitions use Regular Expression matching to perform particular
# actions when called from a step in the .feature file
...
Then(/^I see the Google Search Results Page$/) do
  ...
  # TestFactory Hint: If your GoogleSearchResults class has elements defined,
  # how can you ensure all required elements are loaded?
end
...
Then(/^the Google Search Results Page has Kittens$/) do
  ...
  # TestFactory Hint: What element(s) could you define on the GoogleResultsPage object that
  # would always have text reflecting your search term?
  # TestFactory Hint: Especially if you're checking multiple elements for your search term, what method could you
  # write to perform a singular check for accurate search results?
end
...
Then(/^I see the Google News Results Page$/) do
  ...
  # TestFactory Hint: You can assert the page is loaded and all expected elements exist just as you did
  # above with Google Search Results
end

Then(/^the Google News Results Page has Kittens$/) do
  pending # express the regexp above with the code you wish you had

  # TestFactory Hint: You can assert this page reflects your search term just as you did above with
  # Google Search Results
end

When(/^I click the first result on the Google Search Results page$/) do
  pending # express the regexp above with the code you wish you had
  # Hint: How might you go about figuring out what is the first result
  # without knowing what the text of the link will always be?
  # You will want to look at the attributes of links instead of their text

  # TestFactory Hint: Is there a method you could write for GoogleSearchResults
...
Then(/^I am redirected to the corresponding website from the search result$/) do
  ...
  # TestFactory Hint: You're almost always getting redirected to a non-Google page here and we're not doing
  # anything other than asserting a redirect, so you don't have to model the page you're being redirected
end
